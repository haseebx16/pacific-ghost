  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 mx-auto md:mx-4">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Our Services- Known Among The Best Book Publishing Companies
        </h1>
        <p className="text-gray-500 mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Our Talented Team Of Writers, Publishers And Editors
        </h1>
        <p className="text-gray-500 mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Have A Look At Our Best Book Publishing Services Submissions Guidelines
        </h1>
        <p className="text-gray-500 mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Have Questions About The Publishing Process?
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Contact Us For Your Publishing Concern
        </h1>
        <p className="text-gray-500 mt-2 text-sm">
