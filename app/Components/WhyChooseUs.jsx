...
const WhyChooseUs = () => {
  return (
    <section className={`${Font.className} py-12 bg-sky-50`}>
      <div className="max-w-7xl mx-auto px-8">
        <h2 className="text-2xl text-black font-bold mb-2">WHY DO YOU NEED TO CHOOSE US?</h2>
        <p className="text-gray-600 text-justify text-md mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <ServiceSection title="Branding and Publicity">
              ...
              <p className="text-gray-600 leading-tight text-justify text-md">
