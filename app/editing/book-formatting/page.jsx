  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 px-12 mx-auto md:mx-4">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Why To Choose Our Book Formatting Services
        </h1>
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">We Go For A Customized Approach        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">We Notice Every Detail        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">We Offer Competitive Pricing        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
