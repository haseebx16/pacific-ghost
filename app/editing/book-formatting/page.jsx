  ...
  return (
    <>
      ...
      <div className="md:w-[65%] w-full space-y-8">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 font-bold mt-12">Why To Choose Our Book Formatting Services
        </h1>
        ...
        <h1 className="text-3xl text-sky-500 font-bold md:text-4xl mt-12">We Have Expertise
        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 font-bold mt-12">We Go For A Customized Approach        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl font-bold md:text-4xl mt-12">We Are Always On Time        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 font-bold mt-12">We Notice Every Detail        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mt-12">We Aim For Customer Satisfaction
        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 font-bold mt-12">We Offer Competitive Pricing        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mt-12">Enjoy Coastal Ghostwriting Professional Book Formatting Services For Flawless Stories</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
