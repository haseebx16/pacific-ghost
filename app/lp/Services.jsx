    ...
    <div>
        <section className={`p-20 px-16 flex flex-col text-black justify-center items-center bg-background`}>
                    ...
                    <div className='mt-6 space-x-4'>
                        <button onClick={() => setModalOpen(true)} className='bg-yellow-400 hover:bg-white text-black hover:text-black border-2 border-black px-6 py-2 text-base font-medium transition-colors duration-200'>
                            Activate Your Coupon
                        </button>
                        <button onClick={openLiveChat} className='bg-transparent hover:bg-white text-black hover:text-black border-2 border-black px-6 py-2 text-base font-medium transition-colors duration-200'>
                            Live Chat
                        </button>
                    </div>
