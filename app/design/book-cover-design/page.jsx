  ...
  return (
    <>
      ...
      <div className="md:w-[65%] w-full space-y-8">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Custom Book Cover Design Services: Discover Types And Varieties
        </h1>
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Why We Are The Best Book Cover Designers For Hire
        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Contact Coastal Ghostwriting And Get Your Free Quote Now!
        </h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
