  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 mx-auto md:mx-4">
        ...
        <p className="text-gray-500 mt-2 text-sm">
          1A visionary approach to crafting images and meeting the theme and genre of the book. Pacific Ghostwriting offers custom children’s book illustration services.
        </p>
