  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 mx-auto md:mx-4">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">How Our Best Romance Writers Create A Heartfelt Story</h1>
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">2. Expert Storytelling Skills</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">4. Diversity And Inclusivity</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">6. Creating Immersive World</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
