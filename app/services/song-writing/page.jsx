  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 px-12 mx-auto md:mx-4">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Enjoy Professional Songwriters Service at Coastal Ghostwriting</h1>
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Professional Songwriting Services</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Collaborative Process</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Affordable Pricing</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Lyric Writing</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Song Arrangement</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
