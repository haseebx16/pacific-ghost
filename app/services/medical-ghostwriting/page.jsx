  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 mx-auto md:mx-4">
        ...
        {/* Section 1 */}
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Get The Professional Medical Ghostwriting Services with Coastal Ghostwriting</h1>
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Why Coastal Ghostwriting?</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">Our Comprehensive Medical Writing Services Portfolio</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-3xl text-sky-500 mt-12">Manuscript Preparation</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-3xl text-sky-500 mt-12">Regulatory Writing</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-3xl text-sky-500 mt-12">Educational Materials</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-3xl text-sky-500 mt-12">Medical Marketing Content</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-3xl text-sky-500 mt-12">So, What Are You Waiting For?</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
