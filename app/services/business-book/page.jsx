  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 mx-auto md:mx-4">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Here is How Our Business Book Writing Services Work</h1>
        <p className="text-gray-500 mt-2 text-sm">
        ...
        <h1 className="text-3xl md:text-4xl mt-12">Our Business Book Writers Help You To Become A Published Author</h1>
        <p className="text-gray-500 mt-2 text-sm">
