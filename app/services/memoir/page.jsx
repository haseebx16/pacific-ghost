  ...
  return (
    <>
      ...
      <div className="pt-12 w-[70%] pb-12 px-12 mx-auto md:mx-4">
        ...
        <h1 className="text-3xl md:text-4xl text-sky-500 mt-12">How We Write Your Memoir- Your Success, Our Vision</h1>
        ...
        <h1 className="text-2xl font-bold text-sky-500 md:text-3xl mt-8">Emotional Depth</h1>
        <p className="text-gray-500 text-justify mt-2 text-sm">
        ...
        <h1 className="text-2xl font-bold text-sky-500 md:text-3xl mt-8">Vivid Descriptions</h1>
        ...
        <h1 className="text-2xl font-bold text-sky-500 md:text-3xl mt-8">Universal Themes</h1>
        <p className="text-gray-500 mt-2 text-justify text-sm">
        ...
        <h1 className="text-2xl font-bold md:text-3xl text-sky-500 mt-8">Character Development</h1>
        <p className="text-gray-500 mt-2 text-justify text-sm">
